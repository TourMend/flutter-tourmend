                    ...
                    child: Padding(
                        ...
                        child: CircleAvatar(
                          backgroundImage: ExactAssetImage(
                              'images/lionel-messi-wallpaper-2017-hd.jpg'),
                          radius: 50.0,
                          //child:Image.asset('images/lionel-messi-wallpaper-2017-hd.jpg',fit: BoxFit.cover,width: 80,height: 80,)))
                        )))
              ]),
            )),
        CustomListTile(Icons.person, 'Profile', () => {_onItemTapped}),
        CustomListTile(
            Icons.notifications, 'Notification', () => {_onItemTapped}),
        CustomListTile(Icons.settings, 'Setting', () => {_onItemTapped}),
        CustomListTile(
            Icons.lock,
            'LogOut',
            () => {
